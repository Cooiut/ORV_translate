...
5. **结算规范**：修改完成后仅回答“完成”，随后在本文件更新词汇表。完成整篇文章翻译后需要更新记忆快照栏目与剧情状态。
...
3. **标点与保留规范**：
   ...
   * **前导破折号**：彻底清除对话/独白句首起“包裹”作用的冗余破折号（如 `“——` $\rightarrow$ `“`），但必须保留句尾表达拉长音或被打断的独立破折号（如 `“我——”`）。
...
* Great Return Pill / Daehwadan -> 大还丹
* Griffith -> 格里菲斯
...
### 1. 当前剧情状态 (Plot State)
- **进度**：已成功翻译外传第 1039 至 1045 章（第63话《诸神黄昏（13）～（15）》、第64话《永恒的夜晚（1）～（4）》）。
- **简述**：
